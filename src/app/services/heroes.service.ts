...
export class HeroesService {
  ...
  private heroes: InterfaceHeroes [] = [
    {
      nombre: "Aquaman",
  ...
  getBuscarHeroe(terminoBusqueda: string): InterfaceHeroes[] {

    let heroesArrBuscados: InterfaceHeroes[] = [];
    ...
    for( let heroe of this.heroes ) {
      ...
      if(nombre.indexOf( buscar ) >= 0 )  {
        // -1
        heroesArrBuscados.push( heroe );
      }
    }
    
    return heroesArrBuscados;
  } 
